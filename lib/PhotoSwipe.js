...
var PhotoSwipe = function (_React$Component) {
  ...
  _createClass(PhotoSwipe, [{
    key: 'renderReportPhotoButton',
    value: function renderReportPhotoButton() {
      if (!this.props.onClickReportPhoto) return null;
      return _react2.default.createElement(
        'div',
        { className: 'pswp__top-bar', style: { top: 'initial', bottom: '0' } },
...
PhotoSwipe.propTypes = {
  ...
  onClickReportPhoto: _propTypes2.default.func
};
  ...
  this.handleClickReportPhoto = function () {
    ...
    _this3.setState({
      ...
      if (onClickReportPhoto) {
        onClickReportPhoto(_this3.photoSwipe.getCurrentIndex());
      }
    });
  };
};
